        ...
        <md-card-expand-content>
          <md-card-content>
            <p>
              ...
              submit! You will receive a confirmation e-mail; don't forget to fill out your iLab request and the sample webform before your
              appointment.
            </p>
          </md-card-content>
        </md-card-expand-content>
        ...
        <md-card-expand-content>
          <md-card-content>
            <p>
              ...
              Team has worked to upgrade our genomics.mskcc.org site. Executed in just over a month, the new site provides easier access to
              tools and information while increasing functionality. Please feel free to contact us at genomics@mskcc.org if you have any
