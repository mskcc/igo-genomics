<template>
  <div>
    <div class="md-subheading">Required quantities and qualities of libraries, cDNA, or other materials, either generated by IGO for a downstream process or submitted by the investigator.</div>
    <br />
    <br />
