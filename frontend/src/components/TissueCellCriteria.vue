<template>
  <div>
    <div class="md-subheading subpage-header">
      Requirements for tissue, cells, or other material submitted for extraction or a direct application. Please note: 
      <br />
      <br />
      <ul class="announcement-content">
        <li>If multiple tubes for the same sample are submitted, they will be charged as separate extractions.</li>
        <li>Cells in buffers other than those listed here may incur a $15 extra processing charge and additional turnaround time.</li>
    ...
    <md-table md-card class="criteria-table" id="pass-fail">
      ...
      <md-table-row>
        ...
        <md-table-cell rowspan="2">50-100K cells at > 70% viability in 300-350&mu;L<sup>b<md-tooltip v-if="footnotes.b" md-direction="right">{{ footnotes.b }}</md-tooltip></sup></md-table-cell>
      </md-table-row>
      <md-table-row>
      ...
      <md-table-row>
        ...
        <md-table-cell colspan="2" class="center-page">Streck tubes</md-table-cell>
      ...
      <md-table-row>
        ...
        <md-table-cell>5-10mL tube</md-table-cell>
      ...
      <md-table-row>
        <md-table-cell>Blood<sup>c<md-tooltip v-if="footnotes.c" md-direction="right">{{ footnotes.c }}</md-tooltip></sup></md-table-cell>
      ...
      <md-table-row>
        <md-table-cell>PBMCs<sup>d<md-tooltip v-if="footnotes.d" md-direction="right">{{ footnotes.d }}</md-tooltip></sup></md-table-cell>
        <md-table-cell>Frozen</md-table-cell>
      ...
      <md-table-row>
        ...
        <md-table-cell>200K-1M cells in 1mL<sup>e<md-tooltip v-if="footnotes.e" md-direction="right">{{ footnotes.e }}</md-tooltip></sup></md-table-cell>
      </md-table-row>
      <md-table-row>
      ...
      <md-table-row>
        ...
        <md-table-cell>200K-1M cells in 750:250&mu;L TRIzol LS:PBS<sup>f<md-tooltip v-if="footnotes.f" md-direction="right">{{ footnotes.f }}</md-tooltip></sup></md-table-cell>
      </md-table-row>
      <md-table-row>
        <md-table-cell>RLT buffer + 1% &szlig;-mercaptoethanol</md-table-cell>
      ...
      <md-table-row>
        <md-table-cell>Blood</md-table-cell>
        <md-table-cell colspan="2" class="center-page">PAXgene tube</md-table-cell>
        <md-table-cell>fresh or -20&deg;C</md-table-cell>
        <md-table-cell>10mL</md-table-cell>
      </md-table-row>
      <md-table-row>
        <md-table-cell>RNASeq-SMARTer from cells (96-well)</md-table-cell>
        ...
        <md-table-cell>-80&deg;C to -20&deg;C</md-table-cell>
        <md-table-cell>10 to 1000 cells/well</md-table-cell>
      </md-table-row>
      <md-table-row>
        <md-table-cell>SmartSeq (384-well)</md-table-cell>
        <md-table-cell>Sorted cells</md-table-cell>
        <md-table-cell>Lysis buffer<sup>a<md-tooltip v-if="footnotes.a" md-direction="right">{{ footnotes.a }}</md-tooltip></sup></md-table-cell>
        <md-table-cell>384-well plate<sup>a<md-tooltip v-if="footnotes.a" md-direction="right">{{ footnotes.a }}</md-tooltip></sup></md-table-cell>
        <md-table-cell>-80&deg;C to -20&deg;C</md-table-cell>
  ...
  data: function() {
    return {
      footnotes: {
        ...
        b: 'Samples with insufficient cell number or low viability will be dropped before library prep.',
        c: 'Max volume for one blood extraction is 400\u00B5L; higher volumes (up to 2mL) will incur additional charges.',
        d: 'Max volume for one buffy coat extraction is 200\u00B5L.',
        e: 'A $15 charge will be added for topping up TRIzol volume.',
        f: 'A $15 charge will be added for adjusting TRIzol LS:PBS ratio.',
      },
    };
  },
};
