                ...
                <md-list>
                  <md-list-item md-expand class="md-inset">
                    ...
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                          IGO’s Sample and Project Management Team team is standing by, ready to help.
                          <a
                            href="mailto:zzPDL_SKI_IGO_Sample_and_Project_Management@mskcc.org?subject=Trouble accessing Sample Submission"
                          >
                            Send us an e-mail.
                          </a>
                          If we can’t resolve it immediately, we will get in touch with our Data Team to look deeper into the issue.
                        </div>
                      </md-list-item>
                    </md-list>
                  </md-list-item>
                  <md-list-item md-expand class="md-inset">
                    ...
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                          Yes. Even if it is just for one sample, IGO requires samples to be submitted in plates or sometimes even micronic
                          tubes. IGO has optimized our processes for robotic handling so your samples are handled in an automated, trackable
                          fashion. Therefore, we need samples to be submitted in vessels that our robots can handle. Please note that IGO
                  ...
                  <md-list-item md-expand class="md-inset">
                    <md-icon>add</md-icon>
                    <span class="md-list-item-text">How do I find my iLab Service ID to enter into Sample Submission?</span>
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                          An IGO Service ID is only generated when an iLabs request has been submitted. When creating an iLabs request,
                          iLabs will display IGO-0[CID]. Once the request is submitted to the core, and there are no issues, an IGO Service
                          ID will be generated.The IGO Service ID starts with “IGO-0” and then is followed by a 5-digit number. This is the
                          number entered into Sample Submission.
                        </div>
                      </md-list-item>
                    </md-list>
                  </md-list-item>
                  <md-list-item md-expand class="md-inset">
                    <md-icon>add</md-icon>
                    <span class="md-list-item-text">Why am I not getting an iLab Service ID when I click “submit”?</span>
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                          This issue is most commonly associated with funding issues. Please contact your Research Fund Manager (RFM) to
                          ensure the selected cost center/fund number (cc/fn) are available to you under the selected PI. IGO is not able to
                          help or accept samples without the iLabs submitted under the correct cc/fn.Note: whatever cc/fn is selected at the
                          time of iLabs submission, will be the cc/fn used for billing. So please make sure that the samples are being
                          submitted under the correct cc/fn in order to avoid delay of data and major funding issues downstream.
                        </div>
                      </md-list-item>
                    </md-list>
                  </md-list-item>
                  ...
                  <md-list-item md-expand class="md-inset">
                    ...
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                          We cannot accept human samples collected after December 2019 unless the patient has been screened for COVID19. We
                          offer RNA extraction specifically for COVID19 testing, which you can submit to determine status before starting
                          your project. Submission instructions are
            ...
            <div class="full-control">
              <div class="list">
                <md-list>
                  ...
                  <md-list-item md-expand class="md-inset">
                    <md-icon>add</md-icon>
                    <span class="md-list-item-text">What is the lowest number of cells I can submit for RNA extraction?</span>
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                  ...
                  <md-list-item md-expand class="md-inset">
                    <md-icon>add</md-icon>
                    <span class="md-list-item-text">How much blood do I need to submit for DNA or RNA extraction?</span>
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                  ...
                  <md-list-item md-expand class="md-inset">
                    <md-icon>add</md-icon>
                    <span class="md-list-item-text">How many cells are recommended for 100ng DNA?</span>
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                          ~100K
                  ...
                  <md-list-item md-expand class="md-inset">
                    <md-icon>add</md-icon>
                    <span class="md-list-item-text">Do you perform simultaneous extractions?</span>
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                          Yes. We recommend simultaneous extraction when samples are small and splitting them would decrease both RNA & DNA
                          yields. If you have enough material to split for separate extractions, you may still submit for simultaneous and
                          send the tissue in a single tube.
                        </div>
                      </md-list-item>
                    </md-list>
                  </md-list-item>
                  <md-list-item md-expand class="md-inset">
                    <md-icon>add</md-icon>
                    <span class="md-list-item-text">Does simultaneous extraction favor either RNA or DNA?</span>
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                          Most of the time, the DNA yield is greater than the RNA yield. In the simultaneous process, the sample runs
                          through the DNA column first, which could reduce the RNA yield.
                        </div>
                      </md-list-item>
                    </md-list>
                  </md-list-item>
                  <md-list-item md-expand class="md-inset">
                    <md-icon>add</md-icon>
                    <span class="md-list-item-text">How much DNA and RNA can we extract from bone marrow samples in DMSO?</span>
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                          If the sample quality is good, 300K-1M cells typically yields ~1μg DNA and RNA.
                        </div>
                      </md-list-item>
                    </md-list>
                  </md-list-item>
                  <md-list-item md-expand class="md-inset">
                    <md-icon>add</md-icon>
                    <span class="md-list-item-text">What is the best way to preserve my tissue for downstream processing?</span>
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                          Flash freezing them with minimum processing time.
                        </div>
                      </md-list-item>
                    </md-list>
                  </md-list-item>
                  <md-list-item md-expand class="md-inset">
                    <md-icon>add</md-icon>
                    <span class="md-list-item-text"
                      >How much tissue will I need to submit to get enough DNA for my downstream applications?</span
                    >
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                          Generally, a piece of tissue the size of a grain of rice is sufficient for all downstream applications, including
                          IMPACT, WES, and WGS.
                        </div>
                      </md-list-item>
                    </md-list>
                  ...
                  <md-list-item md-expand class="md-inset">
                    <md-icon>add</md-icon>
                    <span class="md-list-item-text">Should I submit my FFPE samples as blocks, slides, curls, or core punches?</span>
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                  ...
                  <md-list-item md-expand class="md-inset">
                    <md-icon>add</md-icon>
                    <span class="md-list-item-text">How many FFPE slides should I submit?</span>
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                          There is no specific answer. The number of slides needed depends on the tissue area, the thickness of the section,
                          and whether macrodissection is required. Generally, 5-8 slides are sufficent for >10mm, 10-15 slides for 5-10mm,
                          and 20-25 slides for 5mm or smaller. We prefer 10 micron sections for extraction; 5 micron is better for H&E
                          staining.
                        </div>
                      </md-list-item>
                    </md-list>
              ...
              <div class="list">
                <md-list>
                  <md-list-item md-expand class="md-inset">
                    <md-icon>add</md-icon>
                    <span class="md-list-item-text"
                      >I just received my QC results, and some of my samples are “yellow”. Can I go forward anyway?</span
                    >
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                          Yes. We can go forward but cannot guarantee downstream success at either library prep or sequencing.We are always
                          happy to discuss your results and our recommendations. Reach out to us either by commenting on your QC report.
                        </div>
                      </md-list-item>
                    </md-list>
                  </md-list-item>
                  <md-list-item md-expand class="md-inset">
                    <md-icon>add</md-icon>
                    <span class="md-list-item-text"
                      >My DNA/RNA passed QC, but now some of my libraries have failed. How does that happen?</span
                    >
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                  ...
                  <md-list-item md-expand class="md-inset">
                    <md-icon>add</md-icon>
                    <span class="md-list-item-text">Why is my RNA yield or quality so low? I gave you a lot of cells.</span>
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                          Common reasons include:
                          <ul>
                            <li>Sample accidentally thawed and refrozen</li>
                            <li>The cells or tissue do not express much RNA</li>
            ...
            <div class="full-control">
              <div class="list">
                <md-list>
                  <md-list-item md-expand class="md-inset">
                    <md-icon>add</md-icon>
                    <span class="md-list-item-text">Can I make my own library and have IGO sequence it?</span>
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                          Yes. You can either use a commercial kit to make library, or design your own primers. If you do the latter, we
                          require you to submit the sequence or design of your library construct. Contact us for more information or to have
                          your construct verified.
                        </div>
                      </md-list-item>
                    </md-list>
                  </md-list-item>
            ...
            <div class="full-control">
              <div class="list">
                <md-list>
                  <md-list-item md-expand class="md-inset">
                    <md-icon>add</md-icon>
                    <span class="md-list-item-text">I can’t find my data. Who should I reach out to?</span>
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                          ...
                          your data, <a href="mailto:zzPDL_SKI_IGO_DATA@mskcc.org?subject=Trouble accessing data">contact the Data Team.</a>
                        </div>
                      </md-list-item>
                    </md-list>
                  </md-list-item>
                  <md-list-item md-expand class="md-inset">
                    <md-icon>add</md-icon>
                    <span class="md-list-item-text">What genes are included in the targeted sequencing assays?</span>
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
                  ...
                  <md-list-item md-expand class="md-inset">
                    <md-icon>add</md-icon>
                    <span class="md-list-item-text">How should I store blood?</span>
                    <md-list slot="md-expand">
                      <md-list-item>
                        <div>
