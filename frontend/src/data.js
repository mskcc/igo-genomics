export const news = [
  {
    ...
    categories: ['featured'],
    body: `<p>
    Beginning July 1, IGO will deliver .bam alignment files for all human and mouse RNA-Seq experiments in addition to the FASTQ files. Your data folder will now contain a 'pipeline' folder containing these files. You can find more details on .bam generation on our Data & Delivery page.

    Additionally, on <b>August 1</b>, we will delete FASTQ files from 2017 and earlier. This will only apply to IGO-generated FASTQ files, not those generated by analysis groups such as BIC. Please make sure you have copied all files prior to August 1. While we will be able to regenerate the files if necessary after deletion, there will be a significant processing delay.
  </p>`,
  },
  {
