export const news = [
  ...
  },
  {
    ...
    <br />
    The release of the higher-throughput 25B flow cell later this year will also enable lower-cost WGS sequencing coming in 2024!
    </p>`,
  },
  {
...
export const teams = [
  {
    ...
    members: [
      ...
      { name: 'Rachel Tessier', role: 'Supervisor, Sample & Proj. Mgmt', photoName: 'Tessier_Rachel' },
...
export const bulkServices = [
  ...
  },
  {
    ...
    deliverable: 'FASTQ (IMPACT; pipeline analysis options available from BIC with additional charges), pipeline analysis (ACCESS); in development (CMO-CH)',
    tableHeaders: ['panel', 'sampleType', 'sampleCost' ],
    table: [
      { panel: 'IMPACT', sampleType: 'Tumor', sampleCost: 323 },
      { panel: 'IMPACT', sampleType: 'Normal', sampleCost: 191 },
      { panel: 'Mouse IMPACT', sampleType: '', sampleCost: 380 },
      { panel: 'IMPACT-Heme', sampleType: 'Tumor', sampleCost: 323 },
      { panel: 'IMPACT-Heme', sampleType: 'Normal', sampleCost: 191 },
      { panel: 'ACCESS', sampleType: 'Tumor', sampleCost: 600 },
      { panel: 'ACCESS', sampleType: 'Normal', sampleCost: 300 },
      { panel: 'CMO-CH', sampleType: '', sampleCost: 367 },
      { panel: 'Methyl Capture', sampleType: '', sampleCost: 650 },
    ],
  },
  {
    id: 2,
    ...
    libraryChemistry: 'Watchmaker mRNA (polyA), Watchmaker w/ Polaris Depletion (Ribodepletion), SMART-Seq v4 + KAPA EvoPrep (SMARTer)',
    sequencingReadLength: 'PE100',
    ...
    table: [
      { libraryType: 'PolyA', readNumber: '10-20', sampleCost: 185 },
      { libraryType: 'PolyA', readNumber: '20-30', sampleCost: 205 },
      { libraryType: 'PolyA', readNumber: '30-40', sampleCost: 220 },
      { libraryType: 'PolyA', readNumber: '40-50', sampleCost: 235 },
      { libraryType: 'PolyA', readNumber: '50-60', sampleCost: 255 },
      { libraryType: 'PolyA', readNumber: '60-80', sampleCost: 285 },
      { libraryType: 'PolyA', readNumber: '80-100', sampleCost: 320 },
      { libraryType: 'PolyA', readNumber: '100+', sampleCost: 355 },
      { libraryType: 'RiboDepletion', readNumber: '10-20', sampleCost: 260 },
      { libraryType: 'RiboDepletion', readNumber: '20-30', sampleCost: 275 },
      { libraryType: 'RiboDepletion', readNumber: '30-40', sampleCost: 295 },
      { libraryType: 'RiboDepletion', readNumber: '40-50', sampleCost: 310 },
      { libraryType: 'RiboDepletion', readNumber: '50-60', sampleCost: 330 },
      { libraryType: 'RiboDepletion', readNumber: '60-80', sampleCost: 365 },
      { libraryType: 'RiboDepletion', readNumber: '80-100', sampleCost: 400 },
      { libraryType: 'RiboDepletion', readNumber: '100+', sampleCost: 435 },
      // { libraryType: 'RNA Capture', readNumber: '60-80M', sampleCost: 500 },
      { libraryType: 'SMARTer amplification', readNumber: '10-20', sampleCost: 325 },
      { libraryType: 'SMARTer amplification', readNumber: '20-30', sampleCost: 340 },
      { libraryType: 'SMARTer amplification', readNumber: '30-40', sampleCost: 355 },
      { libraryType: 'SMARTer amplification', readNumber: '40-50', sampleCost: 375 },
      { libraryType: 'SMARTer amplification', readNumber: '50-60', sampleCost: 390 },
      { libraryType: 'SMARTer amplification', readNumber: '60-80', sampleCost: 425 },
      { libraryType: 'SMARTer amplification', readNumber: '80-100', sampleCost: 455 },
      { libraryType: 'SMARTer amplification', readNumber: '100+', sampleCost: 490 },
    ],
  },
  {
    id: 3,
    ...
    tableHeaders: ['sampleCoverage', 'sampleCostFrozen', 'sampleCostFfpe'],
    table: [
      { sampleCoverage: 1, sampleCostFrozen: 235 },
      { sampleCoverage: 5, sampleCostFrozen: 245 },
      { sampleCoverage: 10, sampleCostFrozen: 305, sampleCostFfpe: 410 },
      { sampleCoverage: 30, sampleCostFrozen: 550, sampleCostFfpe: 620 },
      { sampleCoverage: 40, sampleCostFrozen: 675, sampleCostFfpe: 760 },
      { sampleCoverage: 50, sampleCostFrozen: 795, sampleCostFfpe: 905 },
      { sampleCoverage: 60, sampleCostFrozen: 915, sampleCostFfpe: 1045 },
      { sampleCoverage: 70, sampleCostFrozen: 1040, sampleCostFfpe: 1190 },
      { sampleCoverage: 80, sampleCostFrozen: 1160, sampleCostFfpe: 1330 },
      { sampleCoverage: 100, sampleCostFrozen: 1405, sampleCostFfpe: 1615 },
      { sampleCoverage: 120, sampleCostFrozen: 1650, sampleCostFfpe: 1900 },
  ...
  },
  {
    ...
    startingMaterial: 'Cells - no more than 24 samples/batch (ATAC), Transposed DNA (ChIP), gDNA (Methyl)',
    libraryChemistry: 'Nextera XT (ATAC), KAPA EvoPrep (ChIP), NEBNext + Twist probes (Methyl)',
    sequencingReadLength: 'PE100',
    sequencingCoverage: '40-50M (ATAC), 10M (ChIP; more reads can be requested), 30-40X (Methyl)',
    deliverable: 'FASTQ + methylation report (Methyl)',
    tableHeaders: ['platform', 'sampleCost'],
    table: [
      { platform: 'ATAC-Seq', sampleCost: 450 },
      { platform: 'ChIP-Seq/CUT&RUN', sampleCost: 250 },
      { platform: 'Methyl Capture Seq', sampleCost: 650 },
    ],
  },
  {
    id: 5,
...
export const singleServices = [
  {
    ...
    sequencingCoverage: '20K reads/cell (standard GEX), 5K reads/cell (V(D)J & cell hashing)',
  ...
  },
  {
    ...
    libraryChemistry: 'Chromium Next GEM',
  ...
  },
  {
    ...
    libraryChemistry: 'Visium Spatial Gene Expression v1 (frozen only) or CytAssist',
  ...
  },
  {
    ...
    deliverable: 'FASTQ, Space Ranger output',
    libraryCost: '6.5mm: $7,750/slide; 11mm (probe-based only): $10,350/slide ',
  ...
  //   tissueOptimizationCost: '$600',
  //   libraryCost: '$2,000 (Cancer atlas) or $2,500 (Whole transcriptome) per slide + $52/ROI',
  //   sequencingCost: '$825-$2,325 per project',
  // },
  // {
  //   id: 7,
  //   name: 'Nanostring CosMx',
  //   description: 'A single molecule imaging program for targeted single-cell spatial transcriptomics',
  //   sequencingCoverage: 'N/A',
  //   deliverable: 'Analysis in Nanostring AtoMx',
  //   startingMaterial: 'FFPE or FF',
  //   runCost: '$1,400/slide + $4,250-9,000/run (panel & size dependent)',
  // },
  {
    id: 8,
...
export const otherServices = [
  {
    id: 0,
    name: 'Digital PCR & Optical Genome Mapping',
    description:
    ...
    startingMaterial: 'ultra high molecular weight DNA (OGM), DNA, RNA, Library',
    deliverable: 'Report',
    tableHeaders: ['service', 'cost'],
    table: [
      { service: 'New ddPCR Assay Design & Optimization', cost: 200 },
      { service: 'New ddPCR Assay Order (CNV/GEX)', cost: 200 },
      { service: 'New ddPCR Assay Order (mutation)', cost: 375 },
      { service: 'Digital PCR (per reaction)', cost: 12 },
      { service: 'ultra hmwDNA extraction + Bionano labeling', cost: 180 },
    ],
  },
  {
    id: 1,
  ...
  // },
  {
    ...
    table: [
      ...
      { serviceType: 'Pathology Service', serviceSubType: 'Slide scraping', price: '$3/slide' },
      { serviceType: 'Pathology Service', serviceSubType: 'Macrodissection', price: '$6/slide' },
    ],
  },
  {
    id: 3,
...
export const customBlockPrices = [
  ...
  { readsBlock: 1600, '100Cycles': '$4032', '200Cycles': 4464, '300Cycles': 4842 },
